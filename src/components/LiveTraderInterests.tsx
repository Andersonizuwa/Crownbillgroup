          ...
          ? [
            {
              ...
              stats: {
                totalTrades: 245, winRate: 78, avgProfit: 12.4, monthlyReturn: 34.2,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 189, winRate: 72, avgProfit: 9.8, monthlyReturn: 28.5,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 312, winRate: 65, avgProfit: 7.2, monthlyReturn: 19.8,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 156, winRate: 81, avgProfit: 11.3, monthlyReturn: 31.4,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 278, winRate: 85, avgProfit: 14.7, monthlyReturn: 42.3,
          ...
          : [
            {
              ...
              stats: {
                totalTrades: 423, winRate: 76, avgProfit: 18.2, monthlyReturn: 52.4,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 356, winRate: 71, avgProfit: 13.5, monthlyReturn: 38.7,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 512, winRate: 82, avgProfit: 21.3, monthlyReturn: 68.5,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 289, winRate: 68, avgProfit: 10.8, monthlyReturn: 24.3,
            ...
            },
            {
              ...
              stats: {
                totalTrades: 634, winRate: 79, avgProfit: 25.4, monthlyReturn: 78.2,
              ...
              >
                <div className="flex items-center gap-3 sm:gap-4 flex-1 min-w-0">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      <span className="font-medium text-foreground truncate max-w-[120px] sm:max-w-none">{trader.name}</span>
                    ...
                    <div className="flex items-center gap-1.5 sm:gap-2 text-xs sm:text-sm flex-wrap">
                      ...
                      <span className="text-muted-foreground truncate">{trader.asset}</span>
                      <span className="text-muted-foreground">({trader.assetSymbol})</span>
                    </div>
                  </div>

                  {/* Profit/Loss - Mobile Layout might move this or shrink it */}
                  <div className={`flex items-center gap-1 font-semibold whitespace-nowrap pt-1 sm:pt-0 ${trader.profit >= 0 ? "text-accent" : "text-destructive"}`}>
                    {trader.profit >= 0 ? (
                      <TrendingUp className="h-3 w-3 sm:h-4 sm:w-4" />
                    ) : (
                      <TrendingDown className="h-3 w-3 sm:h-4 sm:w-4" />
                    )}
                    <span className="text-sm sm:text-base">{trader.profit >= 0 ? "+" : ""}{trader.profit.toFixed(1)}%</span>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-2 sm:shrink-0 w-full sm:w-auto">
                  <Button
                    variant="outline"
                    size="sm"
                    className="flex-1 sm:flex-none h-8 sm:h-9 text-xs sm:text-sm px-2 sm:px-3"
                    onClick={() => handleAnalyze(trader)}
                  >
                    <BarChart2 className="mr-1.5 h-3 w-3 sm:h-4 sm:w-4" />
                    Analyze
                  </Button>
                  <Button
                    variant="accent"
